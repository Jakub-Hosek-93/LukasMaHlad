...
export default function Home() {
  return (
      <main className="min-h-screen font-[inter] bg-white">
          ...
          <section className={"min-h-screen font-[inter] items-center rounded-lg bg-white pt-20 mr-10 ml-10"} id={"about"}>
              ...
              <div
                  ...
                  <p className="text-lg md:text-xl max-w-5xl text-center">
                      ...
                      Tuhle stránku jsem udělal víceméně ze srandy, aby mu lidi mohli hodit pár korun právě na bagetu s
          ...
          <section className={"min-h-screen font-[inter] items-center rounded-lg bg-white pt-20 mr-10 ml-10 text-center"} id={"payment"}>
